 ...
 */
final class Version20220831135835 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT AUTO_INCREMENT NOT NULL, quiz_id INT DEFAULT NULL, question_id INT DEFAULT NULL, choice_id INT DEFAULT NULL, is_right TINYINT(1) NOT NULL, answer_time TIME NOT NULL, INDEX IDX_DADD4A251E27F6BF (question_id), INDEX IDX_DADD4A25998666D1 (choice_id), INDEX IDX_DADD4A25853CD175 (quiz_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
